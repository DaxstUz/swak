...
public abstract class MyUrlRequestCallback extends UrlRequest.Callback {
    ...
    public void onResponseStarted(UrlRequest request, UrlResponseInfo info) {
        ...
        Log.i(TAG, info.getUrl()+" onResponseStarted method called.");
    ...
    public void onReadCompleted(UrlRequest request, UrlResponseInfo info, ByteBuffer byteBuffer) {
        Log.i(TAG, info.getUrl()+" onReadCompleted method called.");
...
//        request.read(ByteBuffer.allocateDirect(102400));
    ...
    public abstract void success(byte[] byteArray);
